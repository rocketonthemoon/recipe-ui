function Instructions() {
  return (
    <div className="instruction">
      ...
      <div className="steps">
        <div className="step">
          <div className="rectangle big">1</div>
        ...
        <div className="step">
          <div className="rectangle big">2</div>
          <div className="procedure">
        ...
        <div className="step">
          <div className="rectangle big">3</div>
          <div className="procedure">
        ...
        <div className="step">
          <div className="rectangle big">4</div>
          <div className="procedure">
        ...
        <div className="step">
          <div className="rectangle big">5</div>
          <div className="procedure">
        ...
        <div className="step">
          <div className="rectangle big">6</div>
          <div className="procedure">
        ...
        <div className="step">
          <div className="rectangle big">7</div>
          <div className="procedure">
